...
# 8 for IPv4
        if eth_proto == 8:
            ...
            print(TAB_3 + 'Protacol: {}, source: {}, Target: {}'.format(proto, src, target))
            ...
            # TCP       
                ...
                print(TAB_2 + 'Source Port: {}, Destination: {}'.format(sequence, acknowledgement))
...
def tcp_segment(data):
    (src_port, dest_port, sequence, acknowledgement, offset_rserved_flags) = struct.unpack('! H H L L H', data[:14])
    ...
    flag_fin = offset_rserved_flags & 5
    return src_port, sequence, acknowledgement, flag_urg, flag_ack, flag_psh, flag_rst, flag_syn, flag_fin, data[offset:]
